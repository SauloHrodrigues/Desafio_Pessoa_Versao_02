...
public class EnderecoServiceImp {
    ...
    protected Endereco atualiza(EnderecoAtualizado atualizacoes){
        Endereco endereco = repository.findById(atualizacoes.id()).orElseThrow(
                ()->new RuntimeException("Endereço não encontrado"));
        return mapper.toUpdade(endereco,atualizacoes);
    }
